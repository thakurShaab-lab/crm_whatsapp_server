...
import { toContactDto, isWindowExpiredForAgent } from '../utils/mappers.js'
...
export async function getContact(req, res) {
  ...
  const [account, lastMessage, lastInboundReply, lastOutboundTemplate] = await Promise.all([
  ...
  res.json(
    toContactDto(mobile, account, lastMessage?.tmpName, {
